...
WD=$(pwd)
LOG_FILE="python-cloud-server.log"
SERVICE_FILE="python-cloud-server.service"
START_SERVICE_FILE="start_service.sh"
STOP_SERVICE_FILE="stop_service.sh"
UNINSTALL_FILE="uninstall_cloud_server.sh"
...
[Unit]
Description=Python Cloud Server
...
echo "${SEPARATOR}"
echo "Python Cloud Server has been installed successfully."
echo
echo "To create a start-up service for the Python Cloud Server, run: './${START_SERVICE_FILE}'"
