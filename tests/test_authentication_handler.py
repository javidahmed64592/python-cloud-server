"""Unit tests for the python_cloud_server.authentication_handler module."""
...
from python_cloud_server.authentication_handler import (
    generate_new_token,
    generate_token,
    hash_token,
    load_hashed_token,
...
def mock_generate_token() -> Generator[MagicMock, None, None]:
    ...
    with patch("python_cloud_server.authentication_handler.generate_token") as mock_generate:
        yield mock_generate
...
def mock_hash_token() -> Generator[MagicMock, None, None]:
    ...
    with patch("python_cloud_server.authentication_handler.hash_token") as mock_hash:
        yield mock_hash
...
def mock_saved_hashed_token() -> Generator[MagicMock, None, None]:
    ...
    with patch("python_cloud_server.authentication_handler.save_hashed_token") as mock_save:
        yield mock_save
