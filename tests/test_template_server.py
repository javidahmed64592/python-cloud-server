"""Unit tests for the python_cloud_server.template_server module."""
...
class TestTemplateServer:
    ...
    def test_init(self, mock_template_server: TemplateServer) -> None:
        ...
        assert mock_template_server.app.title == "python-cloud-server"
        assert mock_template_server.app.description == "A FastAPI cloud server for basic file storage."
